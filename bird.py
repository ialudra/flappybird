...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom = (700, random_pipe_pos - 335))
...
bg_surface = pygame.transform.scale2x(pygame.image.load('assets/images/background-day.png').convert_alpha())
